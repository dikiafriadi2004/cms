...
Route::middleware(['auth', 'verified', 'blocked'])->group(function () {
    ...
    Route::prefix('admin')->group(function (){
        ...
        Route::resource('cms', CmsPageController::class)->names('admin.cms')->parameters(['cms' => 'id'])->middleware(['role_or_permission:Admin CMS']);
        Route::resource('menu', MenuController::class)->names('admin.menu')->parameters(['menu' => 'id'])->middleware(['role_or_permission:Admin Menu']);
