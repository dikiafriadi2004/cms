...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            [
                'key' => 'hero_title',
                'value' => 'Kelola Bisnis Pulsa Anda dengan Mudah',
                'type' => 'text',
                'group' => 'hero',
                'label' => 'Hero Title',
                'description' => 'Judul utama di hero section',
                'sort_order' => 1,
            ],
            [
                'key' => 'hero_subtitle',
                'value' => 'Aplikasi server pulsa terlengkap untuk memudahkan transaksi pulsa, paket data, token listrik, dan pembayaran digital lainnya.',
                'type' => 'textarea',
                'group' => 'hero',
                'label' => 'Hero Subtitle',
            ...
            [
                ...
                'group' => 'hero',
                'label' => 'Hero Image',
                'description' => 'Gambar/screenshot aplikasi di hero section',
                'sort_order' => 5,
            ],
            [
