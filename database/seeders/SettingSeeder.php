...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            [
                'key' => 'hero_title',
                'value' => 'Kelola Bisnis Digital dalam Satu Genggaman',
                'type' => 'textarea',
                'group' => 'hero',
                'label' => 'Hero Title',
                'description' => 'Judul utama di hero section (gunakan Enter untuk line break, baris terakhir akan berwarna brand)',
                'sort_order' => 1,
            ],
            [
                'key' => 'hero_subtitle',
                'value' => 'Aplikasi Konter Digital dirancang khusus untuk memudahkan Anda bertransaksi pulsa, paket data, hingga PPOB dengan interface yang sangat user-friendly.',
                'type' => 'textarea',
                'group' => 'hero',
                'label' => 'Hero Subtitle',
            ...
            [
                ...
                'value' => 'Download Play Store',
                'type' => 'text',
                'group' => 'hero',
                'label' => 'Hero Button Text',
                'description' => 'Teks tombol utama di hero',
                'sort_order' => 4,
            ],
            [
                'key' => 'hero_button_url',
                ...
                'description' => 'Link tombol utama di hero',
                'sort_order' => 5,
            ],
            [
            ...
            [
                ...
                'group' => 'hero',
                'label' => 'Hero Image',
                'description' => 'Gambar/screenshot aplikasi di hero section (ukuran ideal: 350x700px)',
                'sort_order' => 7,
            ],
