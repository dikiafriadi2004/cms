                    ...
                    <div class="preview">
                        ...
                        <div class="form-check mt-5">
                            <input id="vertical-form-3" class="form-check-input" type="checkbox" value="1"
                                ...
                                {{ old('email_verified_at', $user->email_verified_at) == null ? '' : 'checked' }}>
                            <label class="form-check-label" for="vertical-form-3">Verify Email</label>
                        </div>
                        <div class="mt-3">
                            <p>Please enter a new password. If you want to change the password, leave it blank if you don't
                                want to change the password.</p>
                        </div>
                        <div class="mt-3">
                            <label for="vertical-form-2" class="form-label">New Password</label>
                            <input id="vertical-form-2" type="password" name="new_password" class="form-control"
                                placeholder="secret">
                        </div>

                        <div class="mt-3">
                            <label for="vertical-form-2" class="form-label">Confirmation Password</label>
                            <input id="vertical-form-2" type="password" name="new_password_confirmation"
