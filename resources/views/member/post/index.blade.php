        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    <tr class="intro-x">
                        <td>
                            <div class="text-slate-500 font-medium whitespace-nowrap mt-0.5">1</div>
                        </td>
                        <td>
                            <div class="text-slate-500 font-medium whitespace-nowrap mt-0.5">Photography</div>
                        </td>
                        <td class="text-center">Kamis, 20 November 2024</td>
                        <td class="w-40">
