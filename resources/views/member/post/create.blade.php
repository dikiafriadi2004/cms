    ...
    <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
            ...
            <div class="intro-y col-span-12 lg:col-span-8">
                <input type="text" class="intro-y form-control py-3 px-4 box pr-10" name="title" placeholder="Title" value="{{ old('title') }}">
                    ...
                    <div class="post__content tab-content">
                        <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                                ...
                                <div class="mt-5">
                                    <textarea class="w-full" name="description" rows="3">{{ old('content') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="file" class="w-full border border-gray-300 rounded-md p-3 bg-white shadow sm:rounded-lg" name="thumbnail">
                    </div>
                </div>
            </div>
            <!-- END: Post Info -->
