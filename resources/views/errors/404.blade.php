...
<body class="bg-white h-screen flex items-center justify-center p-6 antialiased">
    <div class="max-w-2xl w-full text-center">
        <div class="relative inline-block mb-8">
            <h1 class="text-[120px] sm:text-[180px] font-black text-slate-100 leading-none select-none">404</h1>
        ...
        <div class="space-y-4">
            <h2 class="text-3xl sm:text-4xl font-bold text-slate-900 tracking-tight">Oops! Kamu tersesat.</h2>
            <p class="text-slate-500 text-lg max-w-md mx-auto leading-relaxed">Halaman yang kamu cari tidak ditemukan atau telah dipindahkan ke alamat lain.</p>
        </div>
