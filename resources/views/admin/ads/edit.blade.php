...
@section('content')
<div class="max-w-3xl">
    <form action="{{ route('admin.ads.update', $ad) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
