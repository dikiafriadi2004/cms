...
@section('content')
<form method="POST" action="{{ route('admin.posts.update', $post) }}" id="post-form" class="space-y-6">
    @csrf
    @method('PUT')
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="content" style="display:none;">{{ old('content', $post->content) }}</textarea>
                        @error('content')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3" maxlength="160"
                            ...
                            placeholder="Compelling description for search results...">{{ old('meta_description', $post->meta_description) }}</textarea>
                        <div class="mt-1 flex items-center justify-between">
